...
/**
 * Please analise the next text for logical inconsistencies and write some notes when you will find logic problems, knowing that this is a conceptual blueprint for PHP 7.4.
 * Please ignore all the concerns for Modules “reused between php projects” vs router coupling.
 *
 *
...
{
	protected array $aModules = [//todo check default list??
		AfrCore::class => [
