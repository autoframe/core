	...
	public static function getDefaultFunctionalitiesConfig(): array
	{
		return [
			TestFniBridgeStuff::class => [
				...
				AfrModuleConstantsInterface::anFunctionalitySettings => ['ExtL26B' => 'ExtL26B','Ext-L26B','2.Ext-L26B'],
			],
			TestFniEat::class => [
				...
				AfrModuleConstantsInterface::anFunctionalitySettings => [0=>"A", 3=>'D',4=>'E'],
